...
class sal extends StatelessWidget {
  sal({super.key, required this.ll});
                                  ...
                                  child: Row(
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          "SAR ${ll[i].tableMenuList[0].categoryDishes[k].dishPrice} ",
                                          style: const TextStyle(
                                              color: Colors.black,
                                              fontWeight: FontWeight.bold),
                                        ),
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                            "${ll[i].tableMenuList[0].categoryDishes[k].dishCalories} calories",
                                            style: const TextStyle(
                                                color: Colors.black,
                                                fontWeight: FontWeight.bold)),
                                      ),
