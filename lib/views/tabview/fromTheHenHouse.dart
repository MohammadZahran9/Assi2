...
class HenHouse extends StatelessWidget {
  const HenHouse({super.key});
                                  ...
                                  child: Row(
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          "SAR ${ll[i].tableMenuList[2].categoryDishes[k].dishPrice} ",
                                          style: const TextStyle(
                                              color: Colors.black,
                                              fontWeight: FontWeight.bold),
                                        ),
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                            "${ll[i].tableMenuList[2].categoryDishes[k].dishCalories} calories",
                                            style: const TextStyle(
                                                color: Colors.black,
                                                fontWeight: FontWeight.bold)),
                                      ),
