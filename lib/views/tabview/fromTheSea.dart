...
class TheSea extends StatelessWidget {
  const TheSea({super.key});
...
class sea extends StatelessWidget {
   sea({super.key, required this.ll});
                                  ...
                                  child: Row(
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          "SAR ${ll[i].tableMenuList[3].categoryDishes[k].dishPrice} ",
                                          style: const TextStyle(
                                              color: Colors.black,
                                              fontWeight: FontWeight.bold),
                                        ),
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                            "${ll[i].tableMenuList[3].categoryDishes[k].dishCalories} calories",
                                            style: const TextStyle(
                                                color: Colors.black,
                                                fontWeight: FontWeight.bold)),
                                      ),
