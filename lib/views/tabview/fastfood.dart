...
class Fast extends StatelessWidget {
   Fast({super.key, required this.ll});
                                  ...
                                  child: Row(
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          "SAR ${ll[i].tableMenuList[5].categoryDishes[k].dishPrice} ",
                                          style: const TextStyle(
                                              color: Colors.black,
                                              fontWeight: FontWeight.bold),
                                        ),
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                            "${ll[i].tableMenuList[5].categoryDishes[k].dishCalories} calories",
                                            style: const TextStyle(
                                                color: Colors.black,
                                                fontWeight: FontWeight.bold)),
                                      ),
